...
class RequestContextTest extends TestCase
{
    ...
    {
        $request = Request::create('https://migrateSpec.com:444/foo?bar=baz');
        $requestContext = new RequestContext();
        ...
        $this->assertEquals('migrateSpec.com', $requestContext->getHost());
        $this->assertEquals('https', $requestContext->getScheme());
        ...
        $request = Request::create('http://migrateSpec.com:8080/foo?bar=baz');
        $requestContext = new RequestContext();
