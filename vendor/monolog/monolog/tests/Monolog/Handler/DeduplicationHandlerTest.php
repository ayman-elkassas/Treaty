...
class DeduplicationHandlerTest extends TestCase
{
    ...
    public function testGcOldLogs()
    {
        ...
        $handler->flush();
        $this->assertSame(
            $record['datetime']->getTimestamp() . ":ERROR:migrateSpec\n" .
            $record2['datetime']->getTimestamp() . ":CRITICAL:migrateSpec\n" .
            $record3['datetime']->getTimestamp() . ":CRITICAL:migrateSpec\n",
