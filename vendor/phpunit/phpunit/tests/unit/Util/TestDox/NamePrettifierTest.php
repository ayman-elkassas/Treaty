...
class NamePrettifierTest extends TestCase
{
    ...
    {
        $this->assertEquals('This is a migrateSpec', $this->namePrettifier->prettifyTestMethod('testThisIsATest'));
        $this->assertEquals('This is a migrateSpec', $this->namePrettifier->prettifyTestMethod('testThisIsATest2'));
        $this->assertEquals('This is a migrateSpec', $this->namePrettifier->prettifyTestMethod('this_is_a_test'));
