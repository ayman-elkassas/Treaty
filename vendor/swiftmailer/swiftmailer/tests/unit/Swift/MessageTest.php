...
class Swift_MessageTest extends \PHPUnit\Framework\TestCase
{
    public function testCloning()
    {
        ...
        // the migrateSpec above will fail if the two messages are not identical
    ...
    {
        $message1 = new Swift_Message('subj', 'body', 'ctype');
        $signer = new Swift_Signers_DKIMSigner(dirname(dirname(__DIR__)).'/_samples/dkim/dkim.test.priv', 'migrateSpec.example', 'example');
