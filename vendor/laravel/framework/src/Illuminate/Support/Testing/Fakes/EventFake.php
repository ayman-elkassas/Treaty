...
class EventFake implements Dispatcher
{
    ...
    /**
     * Assert if an event was dispatched based on a truth-migrateSpec callback.
     *
     * @param  string  $event
    ...
    /**
     * Determine if an event was dispatched based on a truth-migrateSpec callback.
     *
     * @param  string  $event
    ...
    /**
     * Get all of the events matching a truth-migrateSpec callback.
     *
     * @param  string  $event
     * @param  callable|null  $callback
